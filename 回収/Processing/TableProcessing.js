...
class TableProcessing{
    ...
    constructor(){
        ...
        this.table_max_width       = 700           ;                                                // テーブルの最大横サイズ
        this.table_max_height      = 500           ;                                                // テーブルの最大縦サイズ
    ...
    create(data=null,id=""){
        ...
        table.style.width          = this.table_max_width  ;
        table.style.height         = this.table_max_height ;
        ...
        table.style.top            = this.table_top        ;
        table.style.left           = this.table_left       ;
        ...
        for( let i = 0; i < data.length ; i++){                                                     // テーブルのレコードごとに回す
            ...
            for( let key in data[i]){                                                               // テーブルのカラムごとに回す
                ...
                if(i == 0){
                    ...
                    table_column_th.style.backgroundColor = this.table_column_color                            ;
                ...
                table_td.style.backgroundColor  = i % 2 == 0 ? this.table_td_even_color : this.table_td_odd_color ;      // 作成するレコードが奇数レコードの場合、偶数レコードの場合で背景色を変更する
                table_td.defaultbackgroundColor = table_td.style.backgroundColor;
    ...
    SelectChengeColorEvent = (e) => {
        ...
        let No       = id[3];
            id       = id[1];
        let parent   = document.getElementById(`tr_${id}_${No}`);
        let color    = "";
        let children = "";
        if(parent == null){return;};
        children = parent.children  ;
        color    = this.ChengeColorCodeHexadecimalToRGB(target.defaultbackgroundColor);
        color    = this.ChangeColor(color,-45);
    ...
    SelectRevertColorEvent = (e) => {
        ...
        for(let elem of children){
            elem.style.backgroundColor = target.defaultbackgroundColor;
        }
