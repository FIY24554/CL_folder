class IndividualGradingChartScreenModel{
    ...
    CreateFrame(){
        ...
        if(this.individual_grading_chart_frame_back != null){return}
        
        // -------------------------------------+
        // 個人成績評価表フレーム               |
        // -------------------------------------+
        this.individual_grading_chart_frame_back                = document.createElement("div")                                                             ;
        this.individual_grading_chart_frame_back.style.width    = this.maine_frame_width                                                                    ;
        this.individual_grading_chart_frame_back.style.height   = this.individual_grading_chart_frame_back_height                                                ;
        this.individual_grading_chart_frame_back.style.position = "absolute"                                                                                ;
        this.individual_grading_chart_frame_back.style.top      = (this.maine_frame_height - parseInt(this.individual_grading_chart_frame_back.style.height)) / 2;
        this.maine_frame.appendChild                         (this.individual_grading_chart_frame_back)                                                     ;
        
        // ---------------------------+
        // 凡例フレーム               |
        // ---------------------------+
        this.individual_grading_chart_frame_front                = document.createElement("div")
        ...
        this.individual_grading_chart_frame_front.style.position = "fixed";
        this.individual_grading_chart_frame_front.style.top      = this.header_height
        this.individual_grading_chart_frame_front.style.left     =  0;
        this.maine_frame.appendChild       (this.individual_grading_chart_frame_front);
        
        // -------------------------------------+
        // 社員テーブル                         |
        // -------------------------------------+
        this.employees_table_frame                         = document.createElement("div")                                                             ;
        this.employees_table_frame.style.width             = this.employees_table_width                                                                ;
        this.employees_table_frame.style.height            = this.employees_table_hieght                                                               ;
        this.employees_table_frame.style.position          = "absolute"                                                                                ;
        this.employees_table_frame.style.top               = this.padding                                                                              ;
        this.individual_grading_chart_frame_back.appendChild     (this.employees_table_frame)                                                               ;
        
        // -------------------------------------+
        // 評価テーブル                         |
        // -------------------------------------+
        this.evaluation_table_frame                        = document.createElement("div")                                                             ;
        this.evaluation_table_frame.style.width            = this.maine_frame_width//this.individual_grading_chart_frame.style.width //this.evaluation_table_width                                                               ;
        this.evaluation_table_frame.style.height           = this.maine_frame_height//this.individual_grading_chart_frame.style.height//this.evaluation_table_height                                                              ;
        this.evaluation_table_frame.style.margin = "auto";
        this.evaluation_table_frame.style.position         = "relative";                                                                                ;
        //this.evaluation_table_frame.style.top              = this.padding * 2 + this.td_height * 2                                                     ;
        //this.evaluation_table_frame.style.left             = 0                                                                                         ;
        this.individual_grading_chart_frame_front.appendChild     (this.evaluation_table_frame)                                                              ;
        
        // -------------------------------------+
        // 経験テーブル                         |
        // -------------------------------------+
        this.experience_table_frame                        = document.createElement("div")                                                             ;
        this.experience_table_frame.style.width            = this.experience_frame_width                                                               ;
        this.experience_table_frame.style.height           = this.experience_frame_height                                                              ;
        this.experience_table_frame.style.position         = "absolute"                                                                                ;
        this.experience_table_frame.style.top              = this.padding * 2 + this.td_height * 2                                                     ;
        this.experience_table_frame.style.right            = 0                                                                                         ;
        this.individual_grading_chart_frame_back.appendChild     (this.experience_table_frame)                                                              ;
        
        // -------------------------------------+
        // 最終評価テーブル                     |
        // -------------------------------------+
        this.final_verdict_table_frame                     = document.createElement("div")                                                             ;
        this.final_verdict_table_frame.style.width         = this.final_verdict_table_table_width                                                      ;
        this.final_verdict_table_frame.style.height        = this.final_verdict_table_table_heigth                                                     ;
        this.final_verdict_table_frame.style.position      = "absolute"                                                                                ;
        this.final_verdict_table_frame.style.top           = this.evaluation_table_height + this.padding * 3 + this.td_height * 2                      ;
        this.final_verdict_table_frame.style.left          = 0                                                                                         ;
        this.individual_grading_chart_frame_back.appendChild     (this.final_verdict_table_frame)                                                           ;
        
        if((parseInt(this.maine_frame.style.height) - parseInt(this.individual_grading_chart_frame_back.style.height)) / 2 < 0){
            this.individual_grading_chart_frame_back.style.top = 0//(parseInt(this.maine_frame.style.height) - parseInt(this.individual_grading_chart_frame_back.style.height)) / 2
...
// ================================================================================================================================================== //
    ...
    CreateEvaluationTable(){
        ...
        this.evaluation_table.style.position = "absolute"                                                  ;
        this.evaluation_table.style.top      = (employees_table_rect["top"] + this.padding  + this.td_height * 2) - this.header_height//this.padding *2  + this.td_height * 2;
        //this.evaluation_table.style.margin   = `auto auto auto auto `                                      ;
